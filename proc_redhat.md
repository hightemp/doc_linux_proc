...
Этот файл дает полную информацию об использовании памяти на уровне плиты. Ядра Linux старше версии 2.2 используют пулы пластин для управления памятью выше уровня страниц. Обычно используемые объекты имеют свои собственные slab pools.
